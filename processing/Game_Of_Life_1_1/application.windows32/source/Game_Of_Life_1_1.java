...
public class Game_Of_Life_1_1 extends PApplet {
...
int alive = color(199, 0, 209);
int dead = color(250,250,250);
...
public void keyPressed() {
  ...
  if (key=='f' || key == 'F') {
    // Fast Forward
    interval = PApplet.parseInt(iinterval/speedFactor);
    
  }
  if (key=='q'||key=='Q')
    {
      //Super Fast Forward
      interval = PApplet.parseInt(iinterval/(speedFactor*4));
    }
  if (key=='w'||key=='W')
    {
...
public void initPattern()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Game_Of_Life_1_1" };
    if (passedArgs != null) {
